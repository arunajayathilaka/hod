...
$_SESSION['N1'] = $_SESSION['N3'] = $_SESSION['N4'] = $_SESSION['N5'] = "";
$_SESSION['N2'] = "activenav";
?>
<html lang="en">
    <head>
        <meta charset="utf-8">
        ...
        <link href="css/compareproduct.css" rel="stylesheet">
        <!-- bxSlider CSS file -->
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12" style="padding-left:5px; padding-right:0px;">
                    <div id="type" class="list-group list-group-horizontal" style="margin-bottom: 5px;">
                        ...
                        <a href="#" class="list-group-item" style="font-weight: bold;width:25%;text-align: center; cursor:pointer; margin-right: 1px;" value="ring">Rings</a>
                        <a href="#" class="list-group-item" style="font-weight: bold;width:25%;text-align: center; cursor:pointer; margin-right: 1px;" value="earring">Earrings</a>
                        <a href="#" class="list-group-item" style="font-weight: bold;width:25%;text-align: center; cursor:pointer;" value="necklace">Necklaces</a> 
                        <a href="#" class="list-group-item" style="font-weight: bold; width:25%;text-align: center; cursor:pointer;" value="bangle">Bangles</a> 
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div id="modaldialog" class="modal-dialog">
                        ...
                        <div class="modal-content" style="background-color: rgba(230,238,255,1);">
                            <div class="modal-header">
                                ...
                                <h4 id="modalhead" class="modal-title">Comparison</h4>
                            </div>
                            ...
                            <div class="panel-body"> 
                                ...
                                <div class="col-md-6">
                                    <ul id="bxslider" class="bxslider">
                                        <li><img id="adimage1" src="http://placehold.it/800x400" style="height:250px; width:800px;" /></li>
                                        <li><img id="adimage2" src="http://placehold.it/800x400" style="height:250px; width:800px;" /></li>
                                        <li><img id="adimage3" src="http://placehold.it/800x400" style="height:250px; width:800px;" /></li>
...
<?php include 'template/footer.php'; ?>		
        ...
        <script type="text/javascript">
                                        ...
                                        /*
                                         function changeShopImage(img){
                                         alert(img);
                                         //document.getElementById('shopImage').src='img/als-images/'+img;
                                         }*/
                                        //close the model
                                        function btnfunc() {
