...
if(isset($_POST['type'])){
	...
	if ($_POST['shopvendor']!="" ){	
            ...
            $productQuery=mysqli_query($link,"SELECT product_items.product_name,product_items.product_dec,product_items.item_id,product_items.product_price,product_items.image_url FROM product_items WHERE product_items.vendor_username='{$shopvendor}' AND product_items.product_type='{$type}'");
		...
		echo '<h2 style="color:black;">not found </h2>';
            ...
            $shopvendor="";
            $productQuery=mysqli_query($link,"SELECT product_items.product_name,vendor.vendor_name,product_items.product_dec,product_items.product_price,product_items.image_url FROM product_items LEFT JOIN vendor ON product_items.vendor_username=vendor.vendor_username WHERE product_items.product_type='{$type}'");
				...
				<div class="col-xs-12 col-sm-4 col-lg-3 col-md-4">
								<div class="thumbnail"style="background-color: rgba(230,238,255,0.5); border: 1px solid #218dfb;">
									...
									<div class="caption">
                                                                            <div style="height:50px; ">
                                                                            <h4 class="pull-right" style="margin-top: 0px;">'.$product1['product_price'].'</h4>
                                                                            <h4><a style="color:black; top:0; text-decoration: none !important; cursor:pointer;">'.$product1['product_name'].'</a></h4>
                                                                            </div>
	...
	echo'<p style="color:white;">tpe  error </p>';
}
?>