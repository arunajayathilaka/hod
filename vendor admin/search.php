<?php
    require 'init.php';
   //select all details for search item
    
    if(isset($_POST['se'])){
        $sqlsearch="SELECT *  FROM product_items WHERE  product_type LIKE '%{$_POST['se']}' OR  product_name LIKE '%{$_POST['se']}'";
        ...
        if($count>0){
                ...
                $se = '<div class="col-sm-5" id="'.$searchdetails["item_id"].'">
                    ...
                    <div class="thumbnail" style="border:1px solid #30a5ff">
                            ...
                            <div class="row">
                                <div class="col-lg-12"  >
                                    <button class="btn btn-primary pul-left updateitemdetails" style="float:right;" data-toggle="modal"  value="'.$searchdetails["item_id"].'" onclick="update('.$searchdetails["item_id"].');"data-target="#updatedetails">Update</button>
