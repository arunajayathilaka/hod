		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>Lumino</span>Admin</a>
					...
					<li><a href="account-sign-in-up.php" style="text-decoration: none !important; cursor:pointer; margin-right:10px;" id="signin"><span class="glyphicon glyphicon-user"></span> Sign In</a></li>

                                        <li><a href="login.php" style="text-decoration: none !important; cursor:pointer; margin-right:20px;" id="login"><span class="glyphicon glyphicon-log-in"></span> Log In</a></li>
                                </ul>     
                        </div>
