...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="charts.html"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg>Products</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
            ...
            <?php 
                ...
                $sql7 = "SELECT * FROM vendor WHERE vendor_email= '{$_SESSION['login_user']}'";
                $res7 = mysqli_query($con,$sql7);
                $row7 = mysqli_fetch_assoc($res7);
                //echo 'fgdfh'.$row7['vendor_username'];
            ?>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default" >
                        ...
                        <div class="panel-heading" >
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-6 col-md-5 col-xs-8"  id="get" value="<?php echo $row7['vendor_username'];?>">
                                ...
                                <div class="col-lg-5 col-xs-4 col-sm-5 col-md-5" style="float:right; margin-top: 7px;">
                                    <div class="input-group">
                                        <input type="text" class="form-control searchtext"  placeholder="Type jewellery type" />
            ...
            <div class="row" id="juwellery">
                ...
                $sql2 = "SELECT * FROM product_items  WHERE vendor_username = '{$row7['vendor_username']}'";
                    ...
                    <div class="thumbnail" style="border:1px solid #30a5ff">
                            <div class="row" id="item">
                                ...
                                <div class="col-lg-6"> 
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <p>Rs.<?php echo "{$productdetails['product_price']}" ?></p>
                            ...
                            <div class="row">
                                <div class="col-lg-12"  >
                                    <button class="btn btn-primary pul-left updateitemdetails" style="float:right;" data-toggle="modal"  value="<?php echo $productdetails["item_id"];?>" onclick="update('<?php echo $productdetails["item_id"];?>')"data-target="#updatedetails">Edit</button>
        ...
        <script>
            ...
            function search(){
                ...
                var get=$('#get').attr('value');
                if(sname!==""){
                    $.ajax({
                        url:'search.php',
                        method:'POST',
                        data:{se: sname,get:get},
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <input class="form-control"type="text" name="proname" required=""/>
                                </div>
                            </div>
                            </br>
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          ...
                                          <input class="form-control"type="text" name="proprice" required=""/>
                            ...
                            <div class="row">
                                <div class="col-lg-3">Product Description</div>
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="">
                                    ...
                                    <div><img class="img-responsive" style="margin-left:10px;width:200px;height: 200px;"src="" height="200" id="itemimage"alt="Image preview..." ></div>        
                                </div>
                            </div>
