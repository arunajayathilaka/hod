...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="charts.php"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg>Products</a></li>
                        <li class="active"><a href="tables.php"><svg class="glyph stroked email"><use xlink:href="#stroked-email"></use></svg>Quotations</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-xs-4 col-sm-5 col-md-5" style="float:right; margin-top:7px;">
                                    <div class="input-group">
                                        <input type="text" class="form-control " id="searchtext" placeholder="Type jewellery type"  />
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="tab-content">
                            ...
                            <?php
                            $sql9 = "SELECT * FROM vendor WHERE vendor_email= '{$_SESSION['login_user']}'";
                            $res9 = mysqli_query($con,$sql9);
                            $row9 = mysqli_fetch_array($res9, MYSQLI_ASSOC);
                            $sqlny = "SELECT * FROM quotation WHERE  vendor = '{$row9['vendor_username']}' AND view = 'yes'";
                            $resny = mysqli_query($con,$sqlny);
                            $sqlno = "SELECT * FROM quotation WHERE  vendor = '{$row9['vendor_username']}' AND view = 'no'";
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal"  enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control"type="text" name="estiprice" id="estiprice"/>
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-default" data-dismiss="modal">Close</button>
                                <button class="btn btn-default"  name="clientsend"  onclick="acceptafter();">Send</button>
                            </div>
                        </form>
        ...
        <script type="text/javascript">
            //checked check boxes .after checking enable delete button.
            function check(){
        ...
        <script>
            //read modal display function with quotation details.
        ...
        <script >
            ...
            function acceptafter(){
                var eprice = $('#estiprice').val();
                var addi = $('#additional').val();
                var phoneno = /^[0-9]{3}/;
                var sender = $('#senderclient').val();
                if(eprice!==""){
                    if(eprice.match(phoneno)){	
                        $.ajax({
                            url:'pdf.php',
                            method:'POST',
                            data:{estprice:eprice,additional:addi,num:sender},
                            success:function(data){
                                alert(data);
                                check();
                            }
			...
			alert("Enter a vaild Estimated Price");
		    }
