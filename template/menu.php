<?php
	...
	if($_SESSION['er1']=="false"){
		...
		<div class="row" id="authe" style="float:right;height:20px;" >
    			...
    			<a href="profile4.php" style="background-color=none;text-decoration: none !important; cursor:pointer;margin-right:10px;color:#3D3D3D;"><span> <img src="'.$row2['pro_pic'].'" class="media-object img-circle pull-left" style="margin-right:4px; width:10%;"><span>'.$_SESSION['emailn'].'</a>
